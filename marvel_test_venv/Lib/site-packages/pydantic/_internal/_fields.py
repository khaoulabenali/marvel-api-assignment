...
def collect_model_fields(  # noqa: C901
    ...
    *,
    ...
    type_hints = _typing_extra.get_cls_type_hints(
        cls, ns_resolver=ns_resolver, lenient=True
    )
    ...
    for base in reversed(cls.__mro__):
        ...
        with ns_resolver.push(base):
            for ann_name, dataclass_field in dataclass_fields.items():
                ...
                ann_type = _typing_extra.eval_type(
                    dataclass_field.type, globalns, localns, lenient=True
                )
